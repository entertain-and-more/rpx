...
class MapWidget(QWidget):
    ...
    def _show_context_menu(self, pos):
        ...
        menu = QMenu(self)
        menu.addAction("Kreis hinzufügen", lambda: self.add_element("circle", scene_pos))
        menu.addAction("Rechteck hinzufügen", lambda: self.add_element("rect", scene_pos))
        menu.addAction("Text hinzufügen", lambda: self.add_element("text", scene_pos))
        menu.addAction("Linie hinzufügen", lambda: self.add_element("line", scene_pos))
        menu.addAction("Gestrichelte Linie hinzufügen", lambda: self.add_element("dashed_line", scene_pos))
        menu.addAction("Bild importieren...", lambda: self._import_image_element(scene_pos))
        menu.addSeparator()
        selected = self.scene.selectedItems()
        del_action = menu.addAction("Element löschen")
